...
def main():
  ...
  if args.env == "spectre_opamp_simple":
    ...
    CIR_YAML = "bag_deep_ckt/eval_engines/spectre/specs_test/" + "vanilla_two_stage_opamp.yaml"
  elif args.env == "spectre_fc":
    CIR_YAML = "bag_deep_ckt/eval_engines/spectre/specs_test/" + "folded_cascode_w_biasing_high_gain.yaml"
  elif args.env == "spectre_fc_biasing":
    CIR_YAML = "bag_deep_ckt/eval_engines/spectre/specs_test/" + "fc_biasing.yaml"
